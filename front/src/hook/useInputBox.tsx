...
export const InpuBoxProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  const contextValue: InputBoxState = { value, setValue, status, setStatus, placeholder, setPlaceholder };
...
export const useInputBox = () => {
  ...
  const { value, setValue, status, setStatus, placeholder, setPlaceholder } = context;
  return { value, setValue, status, setStatus, placeholder, setPlaceholder };
}